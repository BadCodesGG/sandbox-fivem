function CreateVOIPSubmix()
	...
	local gagSubmix = CreateAudioSubmix("Gag")
	SetAudioSubmixEffectRadioFx(gagSubmix, 1)
	SetAudioSubmixEffectParamInt(gagSubmix, 1, `default`, 1)
	SetAudioSubmixEffectParamFloat(gagSubmix, 1, `freq_low`, 10.0)
	SetAudioSubmixEffectParamFloat(gagSubmix, 1, `freq_hi`, 275.0)
	SetAudioSubmixEffectParamFloat(gagSubmix, 1, `rm_mod_freq`, 300.0)
	SetAudioSubmixEffectParamFloat(gagSubmix, 1, `rm_mix`, 0.1)
	SetAudioSubmixEffectParamFloat(gagSubmix, 1, `fudge`, 0.5)
	SetAudioSubmixEffectParamFloat(gagSubmix, 1, `o_freq_lo`, 10.0)
	SetAudioSubmixEffectParamFloat(gagSubmix, 1, `o_freq_hi`, 275.0)
