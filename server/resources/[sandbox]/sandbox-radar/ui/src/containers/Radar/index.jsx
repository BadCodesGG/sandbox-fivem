			...
			<>
				...
				<div className={classes.displayContainer}>
					<DigitalDisplay
						...
						label={props.menu ? 'Menu' : ((props.settings?.transmit && props.radar?.plate) ? `${props.radar?.plate} (${props.radar?.class})` : 'No Plate')}
						colour={'orange'}
					/>
				</div>
				...
				<div className={classes.displayContainer}>
					<DigitalDisplay
						...
						label={props.menu ? 'Mode' : ((props.settings?.transmit && props.fast?.plate) ? `${props.fast?.plate} (${props.fast?.class})` : 'No Plate')}
						colour={'red'}
					/>
				</div>
				<div className={classes.directionContainer}>
