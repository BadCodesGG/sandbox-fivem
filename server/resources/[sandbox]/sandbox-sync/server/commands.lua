function RegisterChatCommands()
    ...
    Chat:RegisterAdminCommand('winter', function(source, args, rawCommand)
        Sync.Set:Winter()
        Chat.Send.Server:Single(source, 'Winter Only Weather Has Been '.. (Sync.Get:Winter() and 'Enabled' or 'Disabled'))
    end, {
