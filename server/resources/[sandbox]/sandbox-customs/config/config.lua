...
_customsConfig.chameleons = {
	{ label = "Black/Disabled", value = 0 },
	{ label = "Monochrome", value = 223 },
	{ label = "Nite Day", value = 224 },
	{ label = "Verlierer", value = 225 },
	{ label = "Sprunk Ex", value = 226 },
	{ label = "Vice City", value = 227 },
	{ label = "Synthwave", value = 228 },
	{ label = "Four Seasons", value = 229 },
	{ label = "Throwback", value = 230 },
	{ label = "Bubblegum", value = 231 },
	{ label = "Rainbow", value = 232 },
	{ label = "Sunsets", value = 233 },
	{ label = "The Seven", value = 234 },
	{ label = "Kamenrider", value = 235 },
	{ label = "Chromabera", value = 236 },
	{ label = "Christmas", value = 237 },
	{ label = "Temperatur", value = 238 },
	-- { label = "HSW", value = 239 },
...
_customsConfig.performanceMods = {
	{ mod = "engine", id = 11, name = "Engine", maxMods = 2 },
	{ mod = "brakes", id = 12, name = "Brakes", maxMods = 2 },
	{ mod = "transmission", id = 13, name = "Transmission", maxMods = 2 },
	{ mod = "suspension", id = 15, name = "Suspension", maxMods = 2 },
}
