...
import { Loader, Modal, Confirm, AppContainer } from '../../components';
	...
	return (
		...
		>
						...
						<>
							...
							{Boolean(selling.loan) && (
								<>
									...
									/>
									<p>
										Remaining Cost After Interest:{' '}
										{CurrencyFormat.format(
											calculateLoanAfterInterest(
												selling.price,
												selling.price *
													(selling.deposit / 100),
											),
			...
			{Boolean(creditCheckView) && (
				...
				>
					<p>
						{creditCheckView.First} {creditCheckView.Last} has a
						credit score of {creditCheckView.Score} so can take out
						a loan of up to{' '}
						{CurrencyFormat.format(creditCheckView.Amount)}
					</p>
				</Confirm>
			)}
		</AppContainer>
