...
AfterHoursNightclubs = {
    ...
    LoadDefault = function()
        ...
        AfterHoursNightclubs.Interior.Lights.Lasers.Clear(AfterHoursNightclubs.Interior.Lights.Lasers.white)
        AfterHoursNightclubs.Interior.Lights.Neons.Clear(AfterHoursNightclubs.Interior.Lights.Neons.purple)
        AfterHoursNightclubs.Interior.Lights.Droplets.Set(AfterHoursNightclubs.Interior.Lights.Droplets.purple)
        AfterHoursNightclubs.Interior.Details.Enable(AfterHoursNightclubs.Interior.Details.truck, false, true)
        AfterHoursNightclubs.Interior.Details.Enable(AfterHoursNightclubs.Interior.Details.lightRigsOff, false, true)
